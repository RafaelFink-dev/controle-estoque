...
uses
  ...
  fmRelatorioProdutos in 'fmConsultaRelatorios\fmRelatorioProdutos.pas' {formRelatorioProdutos},
  fmRelatorioUnidadesMedida in 'fmConsultaRelatorios\fmRelatorioUnidadesMedida.pas' {formRelatorioUnidades};
...
begin
  ...
  Application.CreateForm(TformRelatorioProdutos, formRelatorioProdutos);
  Application.CreateForm(TformRelatorioUnidades, formRelatorioUnidades);
  Application.Run;
end.
